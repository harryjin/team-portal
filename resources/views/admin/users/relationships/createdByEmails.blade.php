    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-createdByEmails">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.email.fields.created_by') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
...
@endcan
  ...
  let table = $('.datatable-createdByEmails:not(.ajaxTable)').DataTable({ buttons: dtButtons })
